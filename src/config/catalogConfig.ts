export type DocEntry = { label: string; url: string };
...
const MANUAL_MAP: Record<string, DocEntry[]> = {
  ...
  CM1_CPU_XP_RED:[{ label: 'CPU 이중화', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Redundancy_v1.0_CPU_BCP65473.pdf` }],
  // ── CM1 전원/베이스 ──
  CM1_PWR:       [{ label: '전원 모듈', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Power_BCP65470_v1.0_20250602.pdf` }],
  CM1_RED_PWR:   [{ label: '전원 모듈', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Power_BCP65470_v1.0_20250602.pdf` }],
  CM1_BASE:      [{ label: '베이스', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_BASE_v1.0_BCP65457.pdf` }],
  CM1_RED_BASE:  [{ label: '베이스', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_BASE_v1.0_BCP65457.pdf` }],
  CM1_ACC:       [{ label: '증설 모듈', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Expansion_v1.0_BCP65464.pdf` }],
  // ── CM1 I/O ──
  ...
  CM1_AO: [{ label: 'DA 아날로그 출력', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_DA_v1.0_BCP65458.pdf` }],
  // ── CM1 온도 ──
  CM1_TEMP_RTD: [{ label: 'RTD', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_RTD_v1.0_BCP65474.pdf` }],
  CM1_TEMP_TC:  [{ label: 'TC 열전대', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_TC_v1.0_BCP65475.pdf` }],
  ...
  CM1_COMM_SERIAL: [{ label: '시리얼', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1 Serial_v1.0_BCP24482.pdf` }],
  CM1_COMM_DNP:    [{ label: '시리얼', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1 Serial_v1.0_BCP24482.pdf` }],
  CM1_COMM_BAC:    [{ label: '시리얼', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1 Serial_v1.0_BCP24482.pdf` }],
  CM1_COMM_CDMA:   [{ label: '시리얼', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1 Serial_v1.0_BCP24482.pdf` }],
  CM1_COMM_CNET:   [{ label: '시리얼', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1 Serial_v1.0_BCP24482.pdf` }],
  // ── CM1 특수 ──
  CM1_SP_HSC: [
  ...
  CM1_SP_POS: [{ label: '위치결정', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Positioning_v1.0_BCP65469.pdf` }],
  // ── CM1 이중화 ──
  CM1_RED_COMM: [{ label: 'Remote I/O', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_RC_RemoteIO_v1.0_BCP65471.pdf` }],
  CM1_RED_EXT:  [{ label: '이중화', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Redundancy_v1.0_BCP65472_20250617.pdf` }],
  CM1_RED_MMI:  [{ label: '이중화', url: `${M1}/간소화매뉴얼(설명서)(국영)CM1_Redundancy_v1.0_BCP65472_20250617.pdf` }],
  ...
  CM3_TEMP_TC:  [{ label: 'TC 열전대', url: `${M3}/RTD_TC/간소화매뉴얼(설명서)(국영)CM3 TC_BCP24448.pdf` }],
  // ── CM3 통신 ──
  ...
  CM3_COMM_SERIAL: [{ label: '시리얼', url: `${M3}/Serial/간소화매뉴얼(설명서)(국영)CM3 Serial_BCP24449_20260319.pdf` }],
  CM3_COMM_CDMA:   [{ label: '시리얼', url: `${M3}/Serial/간소화매뉴얼(설명서)(국영)CM3 Serial_BCP24449_20260319.pdf` }],
  // ── CM3 특수 ──
  CM3_SP_HSC: [
    { label: 'HSC (오픈컬렉터)', url: `${M3}/HSC/간소화매뉴얼(설명서)(국영)CM3 HSC_BCP24446.pdf` },
    { label: 'HSCP (라인드라이브)', url: `${M3}/HSC/간소화매뉴얼(설명서)(국영)CM3 HSCP_BCP65493.pdf` },
  ],
  ...
  XPANEL_HMI: [
    ...
    { label: 'eXT2 (7·10·12·15인치)', url: `${MX}/CM-eXT2 국영-101215_BXP30226_20241114.pdf` },
...
const DRAWING_MAP: Record<string, DocEntry[]> = {
  // ── CM1 ──
  CM1_CPU_UP:    [{ label: 'CPU 모듈', url: `${D1}/CPU-모듈.zip` }],
  CM1_CPU_XP:    [{ label: 'CPU 모듈', url: `${D1}/CPU-모듈.zip` }],
  CM1_CPU_CP:    [{ label: 'CPU 모듈', url: `${D1}/CPU-모듈.zip` }],
  CM1_CPU_XP_RED:[{ label: 'CPU 모듈', url: `${D1}/CPU-모듈.zip` }, { label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_PWR:       [{ label: '전원 모듈', url: `${D1}/전원-모듈.zip` }],
  CM1_RED_PWR:   [{ label: '전원 모듈', url: `${D1}/전원-모듈.zip` }, { label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_BASE:      [{ label: '베이스 모듈', url: `${D1}/베이스-모듈.zip` }],
  CM1_RED_BASE:  [{ label: '베이스 모듈', url: `${D1}/베이스-모듈.zip` }, { label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_DI:        [{ label: 'Digital I/O 모듈', url: `${D1}/IO-Digital-모듈.zip` }],
  CM1_DO:        [{ label: 'Digital I/O 모듈', url: `${D1}/IO-Digital-모듈.zip` }],
  CM1_DIO:       [{ label: 'Digital I/O 모듈', url: `${D1}/IO-Digital-모듈.zip` }],
  CM1_AI:        [{ label: 'Analog I/O 모듈', url: `${D1}/IO-Analog-모듈.zip` }],
  CM1_AO:        [{ label: 'Analog I/O 모듈', url: `${D1}/IO-Analog-모듈.zip` }],
  CM1_TEMP_RTD:  [{ label: 'Analog I/O 모듈', url: `${D1}/IO-Analog-모듈.zip` }],
  CM1_TEMP_TC:   [{ label: 'Analog I/O 모듈', url: `${D1}/IO-Analog-모듈.zip` }],
  CM1_TEMP_TH:   [{ label: 'Analog I/O 모듈', url: `${D1}/IO-Analog-모듈.zip` }],
  CM1_SP_HSC:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_SP_LC:     [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_SP_DL:     [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_SP_POS:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_SERIAL: [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_ETH:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_OPC:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_DNP:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_BAC:    [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_CDMA:   [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_CNET:   [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_COMM_ECAT:   [{ label: '특수 모듈', url: `${D1}/특수-모듈.zip` }],
  CM1_RED_COMM:  [{ label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_RED_MMI:   [{ label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_RED_EXT:   [{ label: '이중화 전용', url: `${D1}/이중화-전용.zip` }],
  CM1_ACC:       [{ label: '증설 모듈', url: `${D1}/증설-모듈.zip` }, { label: '악세서리', url: `${D1}/Accessary.zip` }],
  // ── CM3 ──
  CM3_CPU_SLIM:    [{ label: 'CPU 블록', url: `${D3}/CPU-Main-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_CPU_BRICK:   [{ label: 'CPU 블록', url: `${D3}/CPU-Main-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_CPU_SPLUS:   [{ label: 'CPU 블록', url: `${D3}/CPU-Main-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_DI:          [{ label: '디지털 증설 블록', url: `${D3}/Digital-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_DO:          [{ label: '디지털 증설 블록', url: `${D3}/Digital-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_DIO:         [{ label: '디지털 증설 블록', url: `${D3}/Digital-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_DO_PWM:      [{ label: '특수 모듈', url: `${D3}/특수-모듈.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_AI:          [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_AO:          [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_AIO:         [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_AI_MUX:      [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_TEMP_RTD:    [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_TEMP_TC:     [{ label: '아날로그 증설 블록', url: `${D3}/Analog-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_COMM_ETH:    [{ label: '통신 증설 블록', url: `${D3}/통신-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_COMM_OPC:    [{ label: '통신 증설 블록', url: `${D3}/통신-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_COMM_SERIAL: [{ label: '통신 증설 블록', url: `${D3}/통신-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_COMM_CDMA:   [{ label: '통신 증설 블록', url: `${D3}/통신-증설-Block.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  CM3_SP_HSC:      [{ label: '특수 모듈', url: `${D3}/특수-모듈.zip` }, { label: '단자대', url: `${D3}/단자대.zip` }],
  ...
  PANEL: [
    ...
    { label: 'IPC 500 (12인치)',   url: `${DI}/IPC500Series_12inch.zip` },
    { label: 'IPC 500 (15인치)',   url: `${DI}/IPC500Series_15inch.zip` },
    { label: 'IPC 500 (19인치)',   url: `${DI}/IPC500Series_19inch.zip` },
  ...
  XPANEL_HMI: [
    ...
    { label: 'eXT2 10인치',  url: `${DX}/eXT2_10inch.zip` },
    { label: 'eXT2 12인치',  url: `${DX}/eXT2_12inch.zip` },
    { label: 'eXT2 15인치',  url: `${DX}/eXT2_15inch.zip` },
  ],
  HYBRID_XP: [{ label: 'Hybrid 7인치', url: `${DX}/XPANEL_Hybrid Series_7inch-1.zip` }],
};
