...
export const UI = {
  ...
  quoteMaxItems:    t('품목은 최대 {max}개까지 견적서에 담을 수 있습니다.', 'Up to {max} items can be added to a quote.'),
  quoteMaxItemsWithCurrent: t('품목은 최대 {max}개까지 견적서에 담을 수 있습니다. (현재 {current}개)', 'Up to {max} items can be added to a quote. (Current: {current})'),
